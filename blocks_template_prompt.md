...
- Evitar 'use client' nos blocos (deixar para quem for usar decidir)
...
### 6. Blocos Iniciais (criar pelo menos 3)
...
2. **block-preview.tsx** - Componente de preview interativo
3. **code-block.tsx** - Componente de código com syntax highlighting
4. **app/page.tsx** - Homepage com grid de blocos
5. **app/blocks/[category]/[blockId]/page.tsx** - Página dinâmica individual
6. **blocks/hero/hero1.tsx** - Exemplo de bloco Hero
7. **README.md** - Documentação completa do projeto

## Instruções Finais

- Use apenas classes Tailwind CSS core (não personalizadas)
- Todos os componentes devem ser client components onde necessário
